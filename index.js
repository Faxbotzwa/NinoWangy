...
owner = '994409002319' // Numbers Owner ( MyMans APIs )
ownerNumbers = ["994409002319@s.whatsapp.net","994409002319@s.whatsapp.net","994409002319@s.whatsapp.net"]
...
longkapnye = "\n".repeat(420)
tekuss = `© SoftBot 2021${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by Murphy_\n*Jangan maen bug tod*`
...
│
├ ❏ Creator : MhankBarBar
├ ❏ Recode : MeMans X Hexagonz X Murphy
├ ❏ Thanks : @${tagme}
└──────────────────`
buf = Mthumb
